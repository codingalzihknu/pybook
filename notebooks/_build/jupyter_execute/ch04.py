...
# 조건 제어문과 `while`을 아직 제대로 살펴보진 않았지만
...
# :class: caution
# 
# `int`는 정수 자료형을 가리키면서 동시에 정수 모양의 문자열을 정수로 변환하는 함수
# 이름으로 사용된다.
...
# 변수 이름을 잘못 지정하면 `SyntaxError: invalid syntax`와 
