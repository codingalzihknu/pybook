...
# 이와 같이 프로그램의 실행과 무관한 설명 문장을 
# **주석**<font size="2">comment</font>이라 부르며,
# 프로그램이 실행될 때 파이썬 해석기에 의해 무시된다.
# 
# * 한 줄 주석: 우물 정 또는 영어로 
#     샵<font size="2">sharp</font>이라 불리는 기호(`#`, 샵)로 시작하며
#     `#` 이후의 문장은 실행과정에서 무시된다.
...
# 구문 오류를 포함하지 않는 프로그램이 실행되는 과정에서 발생하는 오류이다.
...
#         (**힌트:** 392.7은 답이 아니다.)
#         
#     1. 책의 정가는 권당 24,950원이지만, 각 권당 10% 의 할인을 받는다고 가정하자.
