...
# 대략적으로 의미를 유추하는 것이 가능할 정도로 자연어와 유사하여
# 입문자 교육용으로도 많이 사용된다.
...
# 파이썬은 들여쓰기로 코드 블록을 구분하는 데, 이는 코드의 가독성을 높인다.
# 또, 파이썬의 간결하고 쉬운 문법은 오류가 발생할 가능성을 낮춰
# 프로그램 개발 속도와 생산성을 높일 수 있다.
# 이에 구글<font size="1">Google</font>, 드롭박스<font size="1">Dropbox</font>, 
# 인스타그램<font size="1">Instagram</font> 등 많은 회사에서 소프트웨어 개발에 파이썬을 사용한다.

# ### 객체 지향 프로그래밍

# 파이썬은 C++, C#, 자바 등과 같이 OOP,  즉
# **객체 지향 프로그래밍**<font size="1">Object-Oriented Programming</font>을 지원한다.
# OOP는 프로그램 전체를 하나로 묶어서 구현하는 것이 아니라 
# 프로그램을 구성하는 객체와 객체들 사이의 관계를 구현하는 
# 프로그래밍 기법이다. 
# OOP를 잘 활용하면 코드의 재사용성을 높이고, 
# 코드의 유지보수가 쉬워진다.
# 
# 파이썬은 모든 것이 객체로 잘 설계되어 있으며 
