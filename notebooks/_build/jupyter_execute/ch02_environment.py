...
# # 온&middot;오프라인 파이썬 개발 환경 설정

# 파이썬 프로그래밍을 하려면 개발환경을 준비해야 한다.
# 파이썬을 아직 설치하지 않았다면, 데이터 분석에 필요한 라이브러리가 포함되어 있는
# 아나콘다<font size = "2">Anaconda</font>를 설치하는 것을 추천한다.
# 
# 이후 다음 중 하나의 방법을 선택하여 개발 환경을 구축한다.
# 
# * 오프라인 개발 환경
...
#     * 구글 코랩 사용
#     
# 이제부터 온&middot;오프라인 개발환경을 설정에 필요한 앱과 웹사이트 사용법을 설명한다.
