...
# 1. 반지름 `r`을 입력 받으면 구의 부피 $\frac{4}{3} \pi r^3$를 출력한다.
...
#     ```
#         
# 1. 오늘의 요일이 주어질 때, 100일 후의 요일을 출력하는 코드를 작성하여라.
...
#     Output : 3 2
# 
# 1. d m 길이의 철로 양끝에 서로 마주보고 있는 두 대의 기차 A, B가 있고,
#     기차 A위에는 파리 한 마리가 있다.
...
#     Output : 16
# 
# 1. 다음과 같은 방법으로 (세 자리 수) × (세 자리 수) 를 계산할 수 있다.   
# 
#     <div align="left">
...
#     ```
# 
# 1. A편의점은 500원, 100원, 50원, 10원을 보유하고 있고,
