...
# **번역기**<font size="2">compiler</font>는 특정 프로그래밍 언어를 다른 프로그래밍 언어로 변환하는 
...
# 그림과 같이 번역기는 소스코드 전체를 오브젝트 코드로 변환한다.
# C, C++, C#, 자바 등이 번역기를 사용하여 소스코드를 변환한 다음에 프로그램이
# 실행되도록 하는 대표적인 언어들이다. 

# ### 실행기

# 번역기와 달리 **실행기**<font size="2">interpreter</font>는 
# 소스코드를 한 줄씩 해석하여 바로 실행되게 한다. 
# 실행기의 작동 방식은 아래 그림과 같다. 

# <div align="center"><img src="https://greenteapress.com/thinkpython/html/thinkpython001.png" style="width:300px;"></div>

# 그림과 같이 실행기를 사용하는 프로그래밍 언어에서는 
# **대화형 프로그래밍**<font size="2">Interactive programming</font>이 가능하다. 
# 파이썬, 루비, 자바스크립트, R 등과 같은 고수준 언어가 실행기를 사용한다.
